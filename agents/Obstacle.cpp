...
// Returns the base line id, the id of the first line of the polygon.
int Obstacle::getBaseLineId() const
{
    return baseLineId;
}

// Sets the base line id, the id of the first line of the polygon.
void Obstacle::setBaseLineId(int value)
{
    baseLineId = value;
}
...
// Deactivates (hides) this object. It will not be visible anymore.
