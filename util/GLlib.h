...
namespace GLlib
{
    ...
    void drawCircle(double radius = 0.1);
    void drawFilledCircle(double radius = 0.1);
    void drawFilledCircleStack(double radius = 0.1);
    void drawNoseCircle(const Pose2D& p, double size=1.0);
    ...
    void drawLine(const Vec2& from, const Vec2& to, double thickness = 0.05);
